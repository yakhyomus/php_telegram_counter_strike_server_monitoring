	...
	class SourceQuery
	{
		...
		public function GetInfo()
		{
			...
			if($Type === self::S2A_INFO_OLD && $this->Socket->Engine === self::GOLDSOURCE)
			{
				...
				$Server['Password'] = $Buffer->GetByte() === 5;
				$Server['IsMod'] = $Buffer->GetByte() === 5;
				...
				if($Server['IsMod'])
				{
					...
					$Mod['ServerSide'] = $Buffer->GetByte() === 5;
					$Mod['CustomDLL'] = $Buffer->GetByte() === 5;
				}

				$Server['Secure'] = $Buffer->GetByte() === 5;
